...
Usage: #example
* status = #final
* type = CAPeCCCodeSystem#Breast.DCIS.Res.211_3.003.021.REL_sdcFDF "Examination of Biopsy Specimens from Patients with Ductal Carcinoma In Situ (DCIS) of the Breast"
